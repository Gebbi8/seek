        ...
        url = URI.parse('https://merge-proto.bio.informatik.uni-rostock.de/bives/simpleMerge.php')
          ...
          http.set_debug_output($stdout)
            req = Net::HTTP::Post::Multipart.new url.path,
              ...
              puts "---"
              if res.body
                redirect_to 'https://merge-proto.bio.informatik.uni-rostock.de/#/?jobID=' + res.body + "&getFile=mergedModel" + "&goBack=" +  request.original_url # call bives-merger website with session id & go back adress to version upload
              else
